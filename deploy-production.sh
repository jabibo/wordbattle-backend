...
gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars="DATABASE_URL=postgresql://postgres:8G9kH2mP4vN1qR7sT6eW@/wordbattle_db?host=/cloudsql/wordbattle-1748668162:europe-west1:wordbattle-db&sslmode=require" \
